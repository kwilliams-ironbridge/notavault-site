...
- **One drill a day**, prescribed. Box 4-count first, because that is the name and the tool operators already trust.
- **One reset tool**, always one tap away: 60 seconds of physiological sighs for rapid down-regulation. The in-the-moment move.
- **Three measurements**, no hardware, every 7 days: resting breathing rate, CO2 tolerance (control pause), exhale control.
- **A 4-week ladder** that raises the count, lengthens the exhale, and grows the hold.
- **The graph.** Proof that regulation is improving, week over week.

## What FourCount is not

- Not a meditation app. No library, no soundscapes, no browsing.
- Not a medical device. No treatment claims, no diagnosis, no HRV medical claims.
- Not endorsed by any branch, unit, or agency. Copy says "used in military and first-responder training" and cites the source. It never says "Navy SEAL app."
- Not Wim Hof in v1. Hyperventilation and cold protocols wait for a safety gate in 1.1.
...
Consumer: $9.99 per month, $59.99 per year with a 14-day trial on annual. Week 1 free.
Institutional (the defensible business): units, departments, teams, and academies through Ironbridge's federal contracting posture. A team dashboard is the v2 feature that unlocks that channel. The consumer app is the proof and the demo.
